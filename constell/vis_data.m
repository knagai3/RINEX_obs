...
if matlab_version >= 5.0                        
  ...
  estruct.variable(5).name = 'earth_model_flag';
  estruct.variable(5).req_dim = [1 1];
  estruct.variable(5).var = earth_model_flag;

  if nargin >= 3,
    estruct.variable(6).name = 'obscure_info';
    estruct.variable(6).req_dim = [901 3];
    estruct.variable(6).var = obscure_info;
  end;
